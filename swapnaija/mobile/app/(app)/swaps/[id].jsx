...
export default function SwapDetailScreen() {
  ...
  return (
    <View style={styles.screen}>
        ...
        <View style={styles.modalOverlay}>
          <ScrollView style={styles.modal} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.modalBtns}>
              <Button title="Cancel" variant="outline" onPress={() => setShowAddressModal(false)} style={{ flex: 1 }} />
              <Button
                title="Save Address"
        ...
        <View style={styles.modalOverlay}>
          <ScrollView style={styles.modal} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.fieldWrap}>
              ...
              <TouchableOpacity style={styles.pickerBtn} onPress={() => setShowCourierPicker(true)}>
            ...
            <FieldInput
              ...
              placeholder="https://track.gigl.com/..."
            />
            <FieldInput
      ...
      {/* Courier Picker */}
      <Modal visible={showCourierPicker} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={[styles.modal, { maxHeight: '65%' }]}>
            <View style={styles.modalTitleRow}>
              <Text style={styles.modalTitle}>Select Courier</Text>
              <TouchableOpacity onPress={() => setShowCourierPicker(false)}>
                <Ionicons name="close" size={22} color={COLORS.textSecondary} />
              </TouchableOpacity>
            </View>
            <ScrollView>
