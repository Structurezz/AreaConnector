...
import {
  ...
  UserCheck, Package, Wrench, Users, Home, MoreHorizontal,
      ...
      <div className="flex-1 overflow-y-auto p-5">
        <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mx-auto pb-8">
              ...
              {PURPOSE_CHIPS.map(({ label, Icon }) => {
                ...
                return (
                  <button key={label} type="button" onClick={() => selectPurpose(label)}
                    ...
                    style={isSelected
                      ? { background: 'rgba(16,185,129,0.08)', borderColor: ACCENT, color: ACCENT_DARK }
          ...
          <button type="submit"
            ...
            <QrCode size={16} />
            {saving ? 'Generating pass…' : 'Create Guest Pass'}
          </button>
