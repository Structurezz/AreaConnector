...
export default function AlertModal() {
  ...
  return (
    <div style={{
      ...
      <style>{`
        @keyframes em-fadeIn { from { opacity: 0; transform: scale(0.96) } to { opacity: 1; transform: scale(1) } }
        @keyframes em-pulse {
      ...
      <div style={{ background: '#fff', borderRadius: 20, width: '100%', maxWidth: 400, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.3)' }}>
        ...
        <div style={{ background: headerGradient, padding: '22px 20px 18px', textAlign: 'center', position: 'relative' }}>
          ...
          <div style={{ width: 60, height: 60, borderRadius: 99, background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 10px', animation: 'em-pulse 1.4s infinite' }}>
        ...
        <div style={{ padding: '16px 20px 22px' }}>
          ...
          <button ref={btnRef} onClick={dismissAlert}
            style={{ width: '100%', padding: '13px', background: '#10B981', color: '#fff', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>
            Acknowledge &amp; Dismiss
          </button>
        </div>
      </div>
