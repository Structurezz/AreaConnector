...
function NotifRow({ n }) {
  ...
  return (
    <div style={{
      ...
      background: n.readAt ? 'transparent' : (cfg.isAlert ? '#FFF5F5' : '#F0FDF9'),
    ...
    <div ref={wrapperRef}>
      ...
      <button
        ...
        style={{
          ...
          border: 'none', background: open ? '#F0FDF9' : 'transparent',
          cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
          color: open ? PRIMARY : '#64748B', transition: 'background 0.15s', flexShrink: 0,
        }}
        onMouseEnter={e => { if (!open) { e.currentTarget.style.background = '#F0FDF9'; e.currentTarget.style.color = PRIMARY; } }}
            ...
            <div style={{ display: 'flex', gap: 4 }}>
              {unreadCount > 0 && (
                <button
                  ...
                  title="Mark all read"
                  style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px 6px', borderRadius: 8, color: PRIMARY, display: 'flex', alignItems: 'center', gap: 4, fontSize: 12, fontWeight: 600 }}
                >
                ...
                {alerts.length > 0 && (
                  <>
                    <div style={{
                      ...
                      padding: '7px 16px 5px', background: '#FFF5F5', borderBottom: '1px solid #FEE2E2',
                    }}>
                ...
                {normal.length > 0 && (
                  <>
                    {alerts.length > 0 && (
                      <div style={{
                        display: 'flex', alignItems: 'center', gap: 6,
                        padding: '7px 16px 5px', background: '#F0FDF9', borderBottom: '1px solid #D1FAE5',
                      }}>
